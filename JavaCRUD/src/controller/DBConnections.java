...
public class DBConnections {
    ...
    private static final String db_con  = "jdbc:mysql://localhost:3306/vehiclerentalsystem"; //THIS HOLDS THE URL OF YOUR MYSQL, THE ONLY VALUE THAT VARIES HERE IS THE PORT NUMBER, BY DEFAULT IT IS SET TO 3306
    ...
    private static  DBConnections dbc; // THIS IS THE SINGLETON FOR THE CLASS DBConnection
